...
Development checkpoint: `dev 0.1.3.7` — **Andromeda**.
...
- Terminal lifecycle polish: active tab close confirmation, connected/disconnected tab markers, disconnect cleanup, clearer remote disconnect/reboot status handling, and reconnect from disconnected xterm.js tabs
