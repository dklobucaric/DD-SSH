...
Development checkpoint: `dev 0.1.4.3` — **Andromeda**.
...
- Settings foundation: terminal font settings, config path visibility, plaintext secrets warning, rotating config-backup policy, and improved initial dialog sizing
