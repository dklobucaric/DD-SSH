...
Development checkpoint: `dev 0.1.3.6` — **Andromeda**.
...
- Terminal lifecycle polish: active tab close confirmation, connected/disconnected tab markers, disconnect cleanup, and clearer remote disconnect/reboot status handling
