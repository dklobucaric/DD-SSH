...
Phase: First local file upload into the current remote folder
```
...
- docs/FILE_TRANSFER_ARCHITECTURE.md explains the planned libssh SFTP/File Manager design and the dev 0.1.7.7 single-file upload checkpoint.
