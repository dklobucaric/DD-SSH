...
- Experimental recursive folder upload/download is available through queue expansion; delete, rename, sync, parallel transfer, resume, permission/timestamp preservation, symlink following, and SFTP traffic monitor integration are not implemented yet
