...
## Compile hotfix check

- [ ] Project compiles past `src/ui/SftpBrowserTab.cpp`.
- [ ] Start queue with no pending items shows a clear informational dialog.
